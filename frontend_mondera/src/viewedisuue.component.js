...
export default class Viewedisuue extends Component {
...
$('#loader_check').fadeIn(400).html('<br><div class="loader_css" ><i class="fa fa-spinner fa-spin" style="font-size:20px"></i>  &nbsp;Please Wait, Checking if Issues has been created...</div>');
			...
			$.ajax({
				url: url_forming+'issues_check_viewedissue.php',
				type: 'post',
...
if(response == 0){
$("#result_check").html("<br /><br /><br /><div style='color:white;background:red;padding:10px;'>There is No Issue Available Yet</div>");   
$('#loader_check').hide();
}
$('#loader_check').hide();		           
...
$("#loader_posts").fadeIn(400).html('<br><div style="color:black;background:white;padding:10px;">Please Wait. Loading Content <i class="fa fa-spinner fa-spin" style="font-size:20px"></i></div>');
            ...
            $.ajax({
                url:url_forming+'issues_load_viewedissue.php',
                type:'post',
...
<br />
<label style={{fontSize:'18px'}}>Listing Issues based on Most Currenlty Viewed by Team Members </label><br />
Issues Currently viewed or access are updated when a user access issues from the <b>alert notification </b>options
at <b>top menu bar</b> and from issue post section  via <b>Reply on the NextPage</b>.  More algorithm coming
soon.
</div><br />
