...
export default class Projectissue extends Component {
...
const projectid_issue = this.props.match.params.projectid;
const projectid_next = projectid_issue;
...
$('#loader_check').fadeIn(400).html('<br><div class="loader_css" ><i class="fa fa-spinner fa-spin" style="font-size:20px"></i>  &nbsp;Please Wait, Checking if Issues has been created...</div>');
			...
			$.ajax({
				url: url_forming+'issues_check_projectissue.php',
				type: 'post',
				data: { projectid_issue:projectid_issue, teamid_issue:teamid_issue},
				dataType: 'json',
				success: function(response){
			
if(response == 0){
$("#result_check").html("<br /><br /><br /><div style='color:white;background:red;padding:10px;'>No Issue has been created on this Project Name Yet</div>");   
$('#loader_check').hide();
}
$('#loader_check').hide();		           
...
$("#loader_posts").fadeIn(400).html('<br><div style="color:black;background:white;padding:10px;">Please Wait. Loading Content <i class="fa fa-spinner fa-spin" style="font-size:20px"></i></div>');
            ...
            $.ajax({
                url:url_forming+'issues_load_projectissue.php',
                type:'post',
                data:{queryid:queryid,page_row_call:page_row_call, teamid_issue:teamid_issue, projectid_issue:projectid_issue},
                dataType:'json',
                success:function(response){
...
<br />
<label style={{fontSize:'18px'}}>Projects Issues Access</label><br />
</div><br />
