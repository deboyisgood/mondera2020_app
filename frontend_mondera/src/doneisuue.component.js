...
export default class Doneisuue extends Component {
...
var rec = "<span>" +
"<img src='https://qbtut.com/mondayserver/" + photo_sess_data +"'  style='text-align:left;border-radius:50%;width:40px;max-width:40px;height:40px;max-height:40px;border-style: solid; border-width:3px; border-color: #3b5998;'>" +
 "</span>";


var rec1 = "<span>" +
"<img src='https://qbtut.com/mondayserver/" + photo_sess_data +"'  style='text-align:left;border-radius:50%;width:30px;max-width:30px;height:30px;max-height:30px;border-style: solid; border-width:3px; border-color: #3b5998;'>" +
 "</span>";
...
$('#loader_check').fadeIn(400).html('<br><div class="loader_css" ><i class="fa fa-spinner fa-spin" style="font-size:20px"></i>  &nbsp;Please Wait, Checking if Issues has been created...</div>');
			...
			$.ajax({
				url: url_forming+'issues_check_doneissue.php',
				type: 'post',
				data: {teamid_issue:teamid_issue},
				dataType: 'json',
				success: function(response){
			
if(response == 0){
$("#result_check").html("<br /><br /><br /><div style='color:white;background:red;padding:10px;'>There is No Done or Closed/Completed Issue Yet</div>");   
$('#loader_check').hide();
}
$('#loader_check').hide();		           
...
$("#loader_posts").fadeIn(400).html('<br><div style="color:black;background:white;padding:10px;">Please Wait. Loading Content <i class="fa fa-spinner fa-spin" style="font-size:20px"></i></div>');
            ...
            $.ajax({
                url:url_forming+'issues_load_doneissue.php',
                type:'post',
                data:{queryid:queryid,page_row_call:page_row_call, teamid_issue:teamid_issue},
                dataType:'json',
                success:function(response){
...
<br />
<label style={{fontSize:'18px'}}>Access List for All Done/Close or Completed Issues </label><br />
</div><br />
